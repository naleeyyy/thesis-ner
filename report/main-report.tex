...
\author{%
    ...
    \authornewline
    %% TODO(krenar): your real JKU address — k<matriculation number>@students.jku.at
    \authormail{k12345678@students.jku.at}
    \authornewline
}
...
\abstract{%
    %% TODO(krenar): write this last, once the annotation results are in. Roughly 120
    %% words: the problem, what was built, the headline numbers, what it means.
    Space for your (short) abstract.%
}
